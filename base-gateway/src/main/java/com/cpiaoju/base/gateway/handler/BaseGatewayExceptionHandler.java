package com.cpiaoju.base.gateway.handler;
 ...
 */
@Slf4j
public class BaseGatewayExceptionHandler extends DefaultErrorWebExceptionHandler {

    public BaseGatewayExceptionHandler(ErrorAttributes errorAttributes, ResourceProperties resourceProperties,
