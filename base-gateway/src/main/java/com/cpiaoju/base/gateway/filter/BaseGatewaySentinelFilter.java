...
import com.cpiaoju.base.gateway.fallback.BaseGatewayBlockFallbackProvider;
...
@Slf4j
@Configuration
public class BaseGatewaySentinelFilter {
    ...
    @PostConstruct
    public void doInit() {
        ZuulBlockFallbackManager.registerProvider(new BaseGatewayBlockFallbackProvider());
        initGatewayRules();
    }
